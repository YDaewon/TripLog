...
CREATE TABLE IF NOT EXISTS `triplog`.`hit_article` (
  ...
  PRIMARY KEY (`hit_id`),
  INDEX `fk_hit_article_article1` (`article_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `triplog`.`hit_plan` (
  ...
  `hit_id` INT NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`hit_id`),
  INDEX `fk_hit_plan_plan1_idx` (`plan_id` ASC) VISIBLE,
  INDEX `fk_hit_plan_user1` (`user_no` ASC) VISIBLE,
  CONSTRAINT `fk_hit_plan_plan1`
    FOREIGN KEY (`plan_id`)
...
CREATE TABLE IF NOT EXISTS `triplog`.`plan_stars` (
  ...
  INDEX `fk_plan_stars_plan1_idx` (`plan_id` ASC) VISIBLE,
  CONSTRAINT `fk_plan_stars_plan1`
    FOREIGN KEY (`plan_id`)
    REFERENCES `triplog`.`plan` (`plan_no`),
...
CREATE TABLE IF NOT EXISTS `triplog`.`article_star` (
  ...
  INDEX `fk_star_board1_idx` (`board_id` ASC) VISIBLE,
